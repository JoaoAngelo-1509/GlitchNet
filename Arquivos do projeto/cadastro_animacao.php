...
<head>
  <meta charset="UTF-8">
  <title>GlitchNet | Registro</title>
  <meta http-equiv="refresh" content="5;url=login.php"> <!-- Redireciona para tela de login -->
  <style>
    body {
...
<body>
  <div>
    <div class="typing">Usuário registrado com sucesso...</div>
    <div class="glitch">GL1TCH_N3T | Login em 5s</div>
  </div>
</body>
</html>
